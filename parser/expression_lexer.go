...
const (
	...
	ExpressionLexerTIMES = 14
	ExpressionLexerDIV = 15
	ExpressionLexerGT = 16
	ExpressionLexerLT = 17
	ExpressionLexerEQ = 18
	ExpressionLexerCOMMA = 19
	ExpressionLexerPOINT = 20
	ExpressionLexerPOW = 21
	ExpressionLexerPI = 22
	ExpressionLexerEULER = 23
	ExpressionLexerI = 24
	ExpressionLexerVARIABLE = 25
	ExpressionLexerSCIENTIFIC_NUMBER = 26
	ExpressionLexerWS = 27
)
